...
import type { AssistantMessage, ContextTierPolicy, Model, Usage } from "@earendil-works/pi-ai";
import { completeSimple, resolveContextTier } from "@earendil-works/pi-ai";
import {
	convertToLlm,
