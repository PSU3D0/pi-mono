...
| `treeFilterMode` | string | `"default"` | Default content filter for `/tree`: `"default"`, `"no-tools"`, `"user-only"`, `"labeled-only"`, `"all"` |
| `treeTimeFilterMode` | string | `"all"` | Default time filter for `/tree`: `"all"`, `"1w"`, `"2w"`, `"3w"`, `"1mo"` |
