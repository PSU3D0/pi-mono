...
describe("getSupportedThinkingLevels", () => {
	...
	it("includes xhigh for GPT-5.5 models", () => {
		...
		expect(getSupportedThinkingLevels(openAIModel!)).toContain("xhigh");
		expect(getSupportedThinkingLevels(codexModel!)).toContain("xhigh");
	});
